...
const EnhancedHeroSection = memo(() => {
  ...
  return (
    <section className={`relative mx-0 lg:mx-16 overflow-hidden ${heroHeight} bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 ${isMobile ? 'mx-2 rounded-lg mt-6' : '' }`}>
