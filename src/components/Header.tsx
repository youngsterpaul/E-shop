...
import { Search as SearchIcon, User, Menu as MenuIcon, X, Home, Package, LogOut, Settings, MapPin, ShoppingBag, Search, Heart, Truck } from 'lucide-react';
            ...
            <div className="flex items-center space-x-4">
              ...
              {user ? <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="px-2 hidden md:flex">
